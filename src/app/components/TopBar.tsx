...
export default function TopBar() {
  return (
    <div className="w-full bg-gray-100 text-gray-900 text-sm">
    ...
    <div className="flex items-center space-x-4">
        <a href="#" className="hover:text-gray-600">
            <FacebookIcon className="h-5 w-5 text-black hover:text-gray-600 transition" />
        </a>
        <a href="#" className="hover:text-gray-600">
            <InstagramIcon className="h-5 w-5 text-black hover:text-gray-600 transition" />
        </a>

    </div>

        {/* Right info */}
        <div className="flex items-center space-x-6 mr-2">   {/* increase number */}
