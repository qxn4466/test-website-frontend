    ...
    <footer className="relative bg-[#062E26] text-white py-20 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-16">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link href="/products/hybrid-solar-tunnel-dryer" className="text-gray-300 hover:text-white transition">Product 1</Link></li>
            <li><Link href="/products/scheffler-dish" className="text-gray-300 hover:text-white transition">Product 2</Link></li>
            <li><Link href="/products/parabolic-cooker" className="text-gray-300 hover:text-white transition">Product 3</Link></li>
            <li><Link href="/products/solar-concentrator" className="text-gray-300 hover:text-white transition">Product 4</Link></li>
            <li><Link href="/products/parabolic-trough" className="text-gray-300 hover:text-white transition">Product 5</Link></li>
          </ul>
        </div>

        {/* Get in Touch */}
        <div>
          <h3 className="font-semibold text-xl mb-4 text-gray-200">Get in touch</h3>

          <p className="text-gray-300 opacity-80 leading-relaxed">
            Address 1
          </p>
